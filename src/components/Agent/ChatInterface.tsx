...
import type { Message, InvestigationStatus, AgentPlan } from '../../types/agent';
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
                ...
                <Container maxWidth="md">
                    {messages.length === 0 && (
                        ...
                        >
                            ...
                            <Typography variant="h4" gutterBottom sx={{ background: 'linear-gradient(45deg, #2196F3 30%, #21CBF3 90%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                                Hello, Human
                            </Typography>
            ...
            <Box
                sx={{
                    ...
                    right: 0,
                    p: 3,
                    background: (theme) => `linear-gradient(to top, ${theme.palette.background.default} 80%, transparent)`,
